...
export const metadata: Metadata = {
  title: "Proceso de Diseño, Fabricación e Instalación | El Letrero Mexicali",
  description:
    "Conoce el proceso de El Letrero para diseñar, fabricar e instalar anuncios luminosos, letreros, letras 3D y fachadas comerciales en Mexicali.",
};
...
const steps = [
  {
    ...
    text: "Revisamos qué tipo de negocio tienes, dónde irá instalado el anuncio, medidas aproximadas y referencias visuales.",
  },
  {
    step: "02",
    title: "Diseño y propuesta",
    text: "Preparamos una propuesta visual para que puedas ver cómo se verá tu letrero, fachada o anuncio luminoso.",
  },
  {
    step: "03",
    title: "Fabricación",
    text: "Trabajamos estructura, materiales, iluminación, cortes, pintura, vinil o letras según lo que necesite el proyecto.",
  },
  {
    step: "04",
    title: "Instalación",
    text: "Montamos el anuncio en sitio y cuidamos que quede firme, visible, limpio y listo para representar tu negocio.",
  },
];
    ...
    <main className={styles.page}>
      ...
      <section className={styles.hero}>
        <div className={styles.heroInner}>
          ...
          <h1>De la idea a la instalación final de tu Letrero.</h1>

          <p>
            En El Letrero trabajamos cada proyecto con un proceso claro:
            asesoría, diseño, fabricación e instalación profesional.
          </p>
      ...
      <section className={styles.section}>
        <div className={styles.sectionInner}>
          <div className={styles.sectionHeader}>
            ...
            <h2>
              Un proceso pensado para que tu negocio se vea mejor desde la
              calle.
            </h2>
          </div>
          ...
          <div className={styles.grid2}>
            <article className={styles.card}>
              <div className={styles.cardImage}>
                <img
                  src="/fabricacion.jpg"
                  alt="Fabricación de letreros y anuncios luminosos en Mexicali"
                />
              </div>

              <div className={styles.cardContent}>
                <span>Fabricación</span>
                <h3>Producción con enfoque comercial.</h3>
                <p>
                  Cada pieza se trabaja pensando en visibilidad, durabilidad,
                  iluminación, estructura, materiales y presencia de marca.
                </p>
              </div>
            </article>
            ...
            <article className={styles.card}>
              ...
              <div className={styles.cardContent}>
                ...
                <h3>Montaje profesional en sitio.</h3>
                <p>
                  Instalamos tu anuncio, letrero o fachada cuidando medidas,
                  estructura, acabados, limpieza e impacto visual.
                </p>
              </div>
            </article>
          </div>
        ...
        <div className={styles.sectionInner}>
          <div className={styles.mapGrid}>
            <div className={styles.infoCard}>
              <span className={styles.kicker}>Antes de fabricar</span>

              <h2>Revisamos tu idea para elegir la mejor solución visual.</h2>

              <p>
                Puedes enviarnos fotos de tu fachada, medidas aproximadas,
                referencias, colores de marca o una idea general. Con eso
                podemos orientarte sobre materiales, iluminación, tamaño y tipo
                de anuncio.
              </p>
            ...
            <div className={styles.card}>
              <div className={styles.cardImage}>
                <img
                  src="/disenoanuncios.jpg"
                  alt="Diseño y propuesta visual para anuncios en Mexicali"
                />
              </div>

              <div className={styles.cardContent}>
                <span>Propuesta visual</span>
                <h3>Tu proyecto empieza con una idea clara.</h3>
                <p>
                  Te ayudamos a visualizar cómo podría verse el anuncio antes de
                  pasar a fabricación e instalación.
                </p>
              </div>
            </div>
          </div>
