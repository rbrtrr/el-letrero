...
export const metadata: Metadata = {
  title: "Proyectos de Letreros y Anuncios Luminosos en Mexicali | El Letrero",
  description:
    "Conoce proyectos de anuncios luminosos, fachadas comerciales, letras 3D, tótems, aretes publicitarios y rotulación realizados por El Letrero Sign Shop en Mexicali.",
};
...
const projects = [
  ...
  },
  {
    ...
    category: "Letras 3D",
    text: "Letras corpóreas para recepciones, oficinas, clínicas y espacios interiores.",
    image: "/letras3d.jpeg",
  },
  {
    ...
    image: "/rotulacionssc.jpg",
  },
  {
    title: "Tótems publicitarios",
    category: "Tótems",
    text: "Estructuras verticales para plazas, negocios, estacionamientos y puntos comerciales.",
    image: "/totemplaza.jpg",
  },
  {
    ...
    <main className={styles.page}>
      ...
      <section className={styles.hero}>
        <div className={styles.heroInner}>
          ...
          <h1>
            Proyectos de anuncios luminosos y fachadas comerciales en Mexicali.
          </h1>

          <p>
            Conoce trabajos reales de El Letrero: letreros luminosos, letras 3D,
            fachadas comerciales, tótems, rotulación, aretes publicitarios y
            señalética para negocios.
          </p>
      ...
      <section className={styles.section}>
        <div className={styles.sectionInner}>
          <div className={styles.sectionHeader}>
            <span className={styles.kicker}>Trabajos terminados</span>

            <h2>
              Resultados visuales para negocios que quieren verse más
              profesionales.
            </h2>
          </div>
        ...
        <div className={styles.sectionInner}>
          <div className={styles.mapGrid}>
            <div className={styles.infoCard}>
              <span className={styles.kicker}>Tu negocio puede ser el siguiente</span>

              <h2>Convierte tu fachada en una referencia visual.</h2>

              <p>
                Si tienes un local, restaurante, clínica, oficina, tienda o
                negocio comercial, podemos ayudarte a crear una solución visual
                que se vea profesional, clara y visible desde la calle.
              </p>
            ...
            <div className={styles.card}>
              <div className={styles.cardImage}>
                <img
                  ...
                  alt="Diseño de anuncios y letreros en Mexicali"
                />
              </div>

              <div className={styles.cardContent}>
                <span>Diseño visual</span>
                <h3>De la idea al resultado final.</h3>
                <p>
                  Revisamos estilo, medidas, materiales, iluminación y ubicación
                  para que tu anuncio se vea bien antes de fabricarlo.
                </p>
              </div>
            </div>
          </div>
